...
from etna.transforms import HolidayTransform, DateFlagsTransform, TimeSeriesImputerTransform, STLTransform, \
    LagTransform, SegmentEncoderTransform, LogTransform
...
def transformers_generator() -> list:
    transforms = [
        ...
        LogTransform(in_column="target", out_column="target_log", inplace=True),
        ...
        STLTransform(in_column="target", model="arima", period=91, robust=True, model_kwargs={"order": (2, 1, 1)}),
